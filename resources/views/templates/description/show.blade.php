<div style="text-align: center">
    <button style="background-color: orange; color: black; border-radius: 5px" class="btn-copy" type="button" onclick="navigator.clipboard.writeText(document.getElementsByTagName('table')[0].outerHTML)">Copy To Clipboard</button>
</div>
        ...
        <td>
            <div id="ds_div">
                <font rwr="1" style="font-family:Arial" size="4">
                    ...
                    <style type="text/css">.element{background:#f8900b}</style>
