<html><head><script>var descGaugeInfo = {descST:(new Date()).getTime()};</script>
    ...
    <script type="text/javascript">
        var ebayItemID='394063822573';
        var ebayItemRevisionTime='1657137783000';
        var ebayAskSellerURL='https://contact.ebay.com/ws/eBayISAPI.dll?ShowSellerFAQ&iid=394063822573&requested=deal_island786&redirect=0&frm=284&rt=nc&_trksid=p2047675.l1499&ssPageName=PageSellerM2MFAQ_VI';
        var _odtTitle = '';
        var _odtSubTitle = '';
        var _isTranslError = false;
        var _sellerId = 'deal_island786';
        var _dmn = 'ebay.com';
    </script>
    <script type="text/javascript">
        try{
    ...
    <title>eBay</title>
</head><body><table style="border-spacing: 0px; width: 100%;" align="center">
    <tbody><tr>
        <td>
            <div id="ds_div">
                <font rwr="1" style="font-family:Arial" size="4">
                    ...
                    <style type="text/css">.element{background:#f8900b}
                    </style>
                    <div class="element" style="font-size: 14pt; border-width: 1px; border-style: solid; border-color: rgb(244, 246, 247) rgb(248, 144, 11) rgb(248, 144, 11); color: rgb(255, 255, 255); line-height: 45px;">
                        ...
                        <font>
                            <font face="Exo">
                                <font>
                                    ...
                                    <div style="border-left: 1px solid #f8900b; border-right: 1px solid #f8900b; border-bottom: 1px solid #f8900b; color: #273C2C; line-height: 25px">
                                        <div class="container" style="padding: 40px 0 40px 0">
                                            <div class="col-12 col-md-12">
                                                <h2 style="color: #f8900b; line-height: 45px"><font face="Exo">Contact us</font></h2>

                                                <hr style="background: #f8900b; height: 1px; width: 10%" align="left">
                                        ...
                                        <div class="element" style="border-left: 1px solid #f8900b; border-right: 1px solid #f8900b; border-top: 1px solid #f8900b; color: #fff; line-height: 45px">
                                            <div class="container" style="padding: 40px 0 40px 0">
                                                <div class="col-12 col-md-12">
                                                    <h1 style="text-align: center"><font face="Exo">Deal Island Policies</font></h1>

                                                    <hr style="background: #fff; height: 1px; width: 10%" align="center"></div>
                                            </div>
                                        </div>

                                        <div style="background: #F4F6F7; border-left: 1px solid #f8900b; border-right: 1px solid #f8900b; color: #353535; ; line-height: 25px">
                                            <div class="container" style="padding-bottom: 20px; padding-top: 50px">
                                                <div class="row">
                                                    <div class="col-12 col-md-4" style="padding-bottom: 10px"><font face="Exo"><img alt="Product" class="mx-auto d-block img-fluid" src="https://i.imgur.com/724SQ5b.png" style="width: 30%" title="Product"></font>
                                                        ...
                                                        <h2 style="color: #f8900b; text-align: center; line-height: 45px"><font face="Exo">Customer Satisfaction</font></h2>
                                                    ...
                                                    <div class="col-12 col-md-4" style="padding-bottom: 10px"><font face="Exo"><img alt="Shipping" class="mx-auto d-block img-fluid" src="https://i.imgur.com/pfnrhbf.png" style="width: 30%" title="Shipping"></font>
                                                        ...
                                                        <h2 style="color: #f8900b; text-align: center; line-height: 45px"><font face="Exo">Shipping</font></h2>
                                                    ...
                                                    <div class="col-12 col-md-4" style="padding-bottom: 10px"><font face="Exo"><img alt="Contact" class="mx-auto d-block img-fluid" src="https://i.imgur.com/mvttR3m.png" style="width: 30%" title="Contact"></font>
                                                        ...
                                                        <h2 style="color: #f8900b; text-align: center; line-height: 45px"><font face="Exo">Contact</font></h2>
                                        ...
                                        <div style="border-left: 1px solid #f8900b; border-right: 1px solid #f8900b; color: #353535; line-height: 25px">
                                            <div class="container" style="padding-top: 40px; padding-bottom: 40px">
                                                <div class="row">
                                                    <div class="col-12 col-md-6" style="padding-bottom: 10px"><font face="Exo"><img alt="Image" class="mx-auto d-block img-fluid" src="https://i.imgur.com/wecHxKm.jpeg" style="width: 40%" title="Image"></font></div>
                                                    ...
                                                    <div class="col-12 col-md-6">
                                                        <div typeof="Product" vocab="https://schema.org/">
                                                            <ul>
                                                                ...
                                                                <li><font face="Exo"><span property="description">Deal Island Try its best to provide our customers the finest and smoothest experience they can ever have and they can buy from us without eeven thinking for a second.</span></font></li>
                                                            </ul>
                                                        </div>
                                                    </div>
                                                </div>
                                        ...
                                        <div style="background: #FDFEFE; border-left: 1px solid #f8900b; border-right: 1px solid #f8900b; color: #353535; line-height: 25px">
                                            <div class="container" style="border-top: 1px solid #F4F6F7; padding: 40px 0 40px 0">
                                                <div class="col-12 col-md-12">
                                                    <h2 style="color: #f8900b; line-height: 45px"><font face="Exo">Details About Services</font></h2>

                                                    <hr style="background: #f8900b; height: 1px; width: 10%" align="left">
                                                    <p><font face="Exo">This Section is for our customers that what they should expect from Deal Island.</font></p>
                                        ...
                                        <div style="border-left: 1px solid #f8900b; border-right: 1px solid #f8900b; border-bottom: 1px solid #f8900b; color: #fff; line-height: 25px">
                                            <div class="col-12 col-md-12 element">
                                                <div class="container" style="padding: 20px 0 20px 0; font-size: 80%; text-align: center">
                                                    <p><font face="Exo">All Rights &amp; Trademarks are reserved by <b>© Deal Island</b>.</font></p>
                                                </div>
                                            </div>
...
<script src="https://ir.ebaystatic.com/rs/v/1yzqmzxk3a3utciscis2t10n1uu.js" type="text/javascript"></script></body></html>
