        ...
        <td>
            <div id="ds_div">
                <font rwr="1" style="font-family:Arial" size="4">
                    ...
                    <style type="text/css">.element{background:#007c6c}</style>
                    <div class="element" style="font-size: 14pt; border-width: 1px; border-style: solid; border-color: #007c6c #007c6c #007c6c; color: rgb(255, 255, 255); line-height: 45px;">
                        <div class="container" style="padding: 40px 0 40px 0">
                            <div class="row">
                                <div style="display: flex; align-items: center;" class="col-2 col-md-2">
                                    <img alt="Image" class="mx-auto d-block img-fluid" src="https://i.ibb.co/rx2yXdd/HUBCO-DEALs.jpg" style="border-radius: 20%;" title="Image">
                                </div>
                    ...
                    <div style="border-left: 1px solid #007c6c; border-right: 1px solid #007c6c; color: rgb(39, 60, 44); line-height: 25px;">
                                    ...
                                    <div class="col-12 col-md-6" style="">
                                        @isset($product_details)
                                            <div typeof="Product" vocab="https://schema.org/" style="">
                                                <h2 style="color: #007c6c; line-height: 45px;"><font style="" size="5" face="Exo">Product Details</font></h2>

                                                <hr style="font-size: 14pt; background: #007c6c; height: 1px; width: 10%;" align="left">
                                                {!! $product_details !!}
                                            </div>
                                        @endisset
                                        @isset($features_and_further_details)
                                            <div typeof="Product" vocab="https://schema.org/" style="">
                                                <h2 style="color: #007c6c; line-height: 45px;"><font style="" size="5" face="Exo">Features and Further Details</font></h2>
                    ...
                    <div style="background: rgb(244, 246, 247); border-left: 1px solid #007c6c; border-right: 1px solid #007c6c; color: rgb(39, 60, 44); line-height: 25px;">
                        <div class="container" style="padding: 40px 0px;">
                            @isset($specifications)
                                <div class="col-12 col-md-12" style="">
                                    <h2 style="color: #007c6c; line-height: 45px;"><font style="" size="5" face="Exo">Specifications</font></h2>
                            ...
                            @isset($dimensions)
                                <div class="col-12 col-md-12" style="">
                                    <h2 style="color: #007c6c; line-height: 45px;"><font style="" size="5" face="Exo">Dimensions</font></h2>
                        ...
                        <font>
                            <font face="Exo">
                                <font>
                                    ...
                                    <div style="border-left: 1px solid #007c6c; border-right: 1px solid #007c6c; border-bottom: 1px solid #007c6c; color: #273C2C; line-height: 25px">
                                        <div class="container" style="padding: 40px 0 40px 0">
                                            <div class="col-12 col-md-12">
                                                <h2 style="color: #007c6c; line-height: 45px"><font face="Exo">Contact us</font></h2>

                                                <hr style="background: #007c6c; height: 1px; width: 10%" align="left">
                                        ...
                                        <div class="element" style="border-left: 1px solid #007c6c; border-right: 1px solid #007c6c; border-top: 1px solid #007c6c; color: #fff; line-height: 45px">
                                            <div class="container" style="padding: 40px 0 40px 0">
                                                <div class="col-12 col-md-12">
                                                    <h1 style="text-align: center"><font face="Exo">HubCo Deals Policies</font></h1>

                                                    <hr style="background: #fff; height: 1px; width: 10%" align="center"></div>
                                            </div>
                                        </div>

                                        <div style="background: #F4F6F7; border-left: 1px solid #007c6c; border-right: 1px solid #007c6c; color: #353535; ; line-height: 25px">
                                            <div class="container" style="padding-bottom: 20px; padding-top: 50px">
                                                <div class="row">
                                                    <div class="col-12 col-md-4" style="padding-bottom: 10px"><font face="Exo"><img alt="Product" class="mx-auto d-block img-fluid" src="https://i.imgur.com/724SQ5b.png" style="width: 30%" title="Product"></font>
                                                        ...
                                                        <h2 style="color: #007c6c; text-align: center; line-height: 45px"><font face="Exo">Customer Satisfaction</font></h2>
                                                    ...
                                                    <div class="col-12 col-md-4" style="padding-bottom: 10px"><font face="Exo"><img alt="Shipping" class="mx-auto d-block img-fluid" src="https://i.imgur.com/pfnrhbf.png" style="width: 30%" title="Shipping"></font>
                                                        ...
                                                        <h2 style="color: #007c6c; text-align: center; line-height: 45px"><font face="Exo">Shipping</font></h2>
                                                    ...
                                                    <div class="col-12 col-md-4" style="padding-bottom: 10px"><font face="Exo"><img alt="Contact" class="mx-auto d-block img-fluid" src="https://i.imgur.com/mvttR3m.png" style="width: 30%" title="Contact"></font>
                                                        ...
                                                        <h2 style="color: #007c6c; text-align: center; line-height: 45px"><font face="Exo">Contact</font></h2>
                                        ...
                                        <div style="border-left: 1px solid #007c6c; border-right: 1px solid #007c6c; color: #353535; line-height: 25px">
                                            <div class="container" style="padding-top: 40px; padding-bottom: 40px">
                                                <div class="row">
                                                    <div class="col-12 col-md-6" style="padding-bottom: 10px"><font face="Exo"><img alt="Image" class="mx-auto d-block img-fluid" src="https://i.ibb.co/rx2yXdd/HUBCO-DEALs.jpg" style="width: 40%" title="Image"></font></div>
                                                    ...
                                                    <div class="col-12 col-md-6">
                                                        <div typeof="Product" vocab="https://schema.org/">
                                                            <ul>
                                                                ...
                                                                <li><font face="Exo"><span property="description">HubCo Deals Try its best to provide our customers the finest and smoothest experience they can ever have and they can buy from us without eeven thinking for a second.</span></font></li>
                                                            </ul>
                                                        </div>
                                                    </div>
                                                </div>
                                        ...
                                        <div style="background: #FDFEFE; border-left: 1px solid #007c6c; border-right: 1px solid #007c6c; color: #353535; line-height: 25px">
                                            <div class="container" style="border-top: 1px solid #F4F6F7; padding: 40px 0 40px 0">
                                                <div class="col-12 col-md-12">
                                                    <h2 style="color: #007c6c; line-height: 45px"><font face="Exo">Details About Services</font></h2>

                                                    <hr style="background: #007c6c; height: 1px; width: 10%" align="left">
                                                    <p><font face="Exo">This Section is for our customers that what they should expect from HubCo Deals.</font></p>
                                        ...
                                        <div style="border-left: 1px solid #007c6c; border-right: 1px solid #007c6c; border-bottom: 1px solid #007c6c; color: #fff; line-height: 25px">
                                            <div class="col-12 col-md-12 element">
                                                <div class="container" style="padding: 20px 0 20px 0; font-size: 80%; text-align: center">
                                                    <p><font face="Exo">All Rights &amp; Trademarks are reserved by <b>© HubCo Deals</b>.</font></p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
